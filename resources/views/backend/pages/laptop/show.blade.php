...
@section('title','Show Laptop')
@section('content')
<div class="col-12 grid-margin">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Show Laptop</h4>
        <form action="{{url('/admin/products/laptop/'.$laptop->id)}}" method="get" enctype="multipart/form-data" >
            @csrf
            @method('get')
          <div class="row">
            <div class="col-md-6">
         ...
         <a href="{{url('/admin/products/laptop')}}" class="btn btn-rounded btn-danger p-3 fw-bold">Back</a>
        </form>
